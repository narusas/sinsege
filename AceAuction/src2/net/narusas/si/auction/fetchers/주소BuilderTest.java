...
public class 주소BuilderTest extends TestCase {
	...
	public void test2(){
		//경기도 화성시 향남읍 행정동로 22, 1504동 8층 802호 (향남시범살구꽃마을화성파크드)

		//
		assert소재지("경기도", 		null, 		"화성시",				"향남읍", 		null	, 	null, 		"1504동 8층 802호 (향남시범살구꽃마을화성파크드)","행정동로", null,				22, null,  주소Builder.parse소재지("경기도 화성시 향남읍 행정동로 22, 1504동 8층 802호 (향남시범살구꽃마을화성파크드)"));
