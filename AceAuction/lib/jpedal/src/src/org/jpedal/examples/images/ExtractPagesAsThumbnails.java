...
* Contributor(s):
* 
* 2003-09-30	Option to select output format as jpg, tif or png added
* 
* 2004-02-11	Add method to get outputDir and images no longer in sub-directories.
* 
* 2004-06-17	Add code to show higer quality bicubic scaling
*
*2004-09-15	Add improved font mapping for default fonts
*/
 ...
 * page which it saves as a thumbnail <br>Scope:<b>(Ent/Viewer/LGPL only)</b>
 * 
 *
 */
