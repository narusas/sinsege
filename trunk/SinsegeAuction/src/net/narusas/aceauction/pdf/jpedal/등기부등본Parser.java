...
public class 등기부등본Parser {
	...
	/**
	 * Instantiates a new 등기부등본 parser.
	 */
	public 등기부등본Parser() {
	 ...
	 * Collect contents.
	 * 
	 * @param decodePdf the decode pdf
	 * @param start the start
	 * @param end the end
	 * @param list the list
	 * 
	 * @throws Exception the exception
	 * @throws PdfException the pdf exception
	 */
	 ...
	 * Sort.
	 * 
	 * @return the linked list< text position>
	 */
