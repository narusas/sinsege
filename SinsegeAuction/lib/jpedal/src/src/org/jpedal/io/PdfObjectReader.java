...
public interface PdfObjectReader {
	...
	public byte[] readStream(Map objData, String objectRef, boolean cacheValue,
			boolean decompress, boolean keepRaw);
	 ...
	 *
	 */
	public Map readObject(String objectRef, boolean isEncryptionObject,
			Map textFields);
	 ...
	 *
	 */
	public byte[] readObjectAsByteArray(String objectRef,
			boolean isEncryptionObject);
	 ...
	 * </p>
	 */
	public byte[] decodeFilters(byte[] data, String filter_list, Map objData,
